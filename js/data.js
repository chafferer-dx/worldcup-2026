...
const MATCHES = [
  // ── Matchday 1 ──
  { id:"A1", date:"2026-06-12", time:"03:00", group:"A", home:"MEX", away:"RSA", venue:"墨西哥城",
  ...
  { id:"A2", date:"2026-06-12", time:"10:00", group:"A", home:"KOR", away:"CZE", venue:"瓜达拉哈拉",
  ...
  { id:"B1", date:"2026-06-13", time:"03:00", group:"B", home:"CAN", away:"BIH", venue:"多伦多",
    status:"finished", score:{h:1,a:1}, events:[
      {m:21, t:"goal", p:"J. Lukić", team:"BIH"},
      {m:78, t:"goal", p:"C. Larin", team:"CAN"}
    ],
    ...
    post_match:"🎯 比分完全命中！预测1-1与实际完全一致。成功预判了戴维斯缺阵对加拿大进攻端的影响,以及波黑凭经验率先进球后加拿大主场反扑的剧本。加拿大收获队史世界杯首个积分,波黑亦满意客场拿分。",
    odds:{h:2.50, d:3.20, a:2.80, move:"home_slight_in"}
  },
  { id:"D1", date:"2026-06-13", time:"09:00", group:"D", home:"USA", away:"PAR", venue:"洛杉矶",
    status:"finished", score:{h:4,a:1}, events:[
      {m:7, t:"goal", p:"D. Bobadilla (OG)", team:"PAR"},
      {m:31, t:"goal", p:"F. Balogun", team:"USA"},
      {m:45+4, t:"goal", p:"F. Balogun", team:"USA"},
      {m:68, t:"goal", p:"A. Sanabria", team:"PAR"},
      {m:90+1, t:"goal", p:"G. Reyna", team:"USA"}
    ],
    ...
    post_match:"❌ 预测方向正确但比分偏差较大。预测2-0,实际4-1。低估了三点:1)巴拉圭开场乌龙送大礼,7分钟就打破僵局;2)巴洛贡状态爆棚半场梅开二度;3)普利西奇全场2助攻,组织核心作用超出预期。美国展现了冠军级攻击力,巴拉圭防线比预期脆弱得多。",
    odds:{h:1.65, d:3.60, a:5.00, move:"home_in"}
  },
  { id:"B2", date:"2026-06-14", time:"03:00", group:"B", home:"QAT", away:"SUI", venue:"旧金山",
  ...
  { id:"C1", date:"2026-06-14", time:"06:00", group:"C", home:"BRA", away:"MAR", venue:"纽约",
    status:"upcoming", score:null, events:[],
  ...
  { id:"C2", date:"2026-06-14", time:"09:00", group:"C", home:"HAI", away:"SCO", venue:"波士顿",
    status:"upcoming", score:null, events:[],
  ...
  { id:"D2", date:"2026-06-14", time:"12:00", group:"D", home:"AUS", away:"TUR", venue:"温哥华",
    status:"upcoming", score:null, events:[],
  ...
  { id:"E1", date:"2026-06-15", time:"01:00", group:"E", home:"GER", away:"CUW", venue:"休斯顿",
    status:"upcoming", score:null, events:[],
  ...
  { id:"F1", date:"2026-06-15", time:"04:00", group:"F", home:"NED", away:"JPN", venue:"达拉斯",
    status:"upcoming", score:null, events:[],
  ...
  { id:"E2", date:"2026-06-15", time:"07:00", group:"E", home:"CIV", away:"ECU", venue:"费城",
    status:"upcoming", score:null, events:[],
  ...
  { id:"F2", date:"2026-06-15", time:"10:00", group:"F", home:"SWE", away:"TUN", venue:"蒙特雷",
    status:"upcoming", score:null, events:[],
  ...
  { id:"H1", date:"2026-06-16", time:"00:00", group:"H", home:"ESP", away:"CPV", venue:"亚特兰大",
    status:"upcoming", score:null, events:[],
  ...
  { id:"G1", date:"2026-06-16", time:"03:00", group:"G", home:"BEL", away:"EGY", venue:"西雅图",
    status:"upcoming", score:null, events:[],
  ...
  { id:"H2", date:"2026-06-16", time:"06:00", group:"H", home:"KSA", away:"URU", venue:"迈阿密",
    status:"upcoming", score:null, events:[],
  ...
  { id:"G2", date:"2026-06-16", time:"09:00", group:"G", home:"IRN", away:"NZL", venue:"洛杉矶",
    status:"upcoming", score:null, events:[],
  ...
  { id:"I1", date:"2026-06-17", time:"03:00", group:"I", home:"FRA", away:"SEN", venue:"纽约",
    status:"upcoming", score:null, events:[],
  ...
  { id:"I2", date:"2026-06-17", time:"06:00", group:"I", home:"IRQ", away:"NOR", venue:"波士顿",
    status:"upcoming", score:null, events:[],
  ...
  { id:"J1", date:"2026-06-17", time:"09:00", group:"J", home:"ARG", away:"ALG", venue:"堪萨斯城",
    status:"upcoming", score:null, events:[],
  ...
  { id:"J2", date:"2026-06-17", time:"12:00", group:"J", home:"AUT", away:"JOR", venue:"旧金山",
    status:"upcoming", score:null, events:[],
  ...
  { id:"K1", date:"2026-06-18", time:"01:00", group:"K", home:"POR", away:"COD", venue:"休斯顿",
    status:"upcoming", score:null, events:[],
  ...
  { id:"L1", date:"2026-06-18", time:"04:00", group:"L", home:"ENG", away:"CRO", venue:"达拉斯",
    status:"upcoming", score:null, events:[],
  ...
  { id:"L2", date:"2026-06-18", time:"07:00", group:"L", home:"GHA", away:"PAN", venue:"多伦多",
    status:"upcoming", score:null, events:[],
  ...
  { id:"K2", date:"2026-06-18", time:"10:00", group:"K", home:"UZB", away:"COL", venue:"墨西哥城",
    status:"upcoming", score:null, events:[],
  ...
  // ── Matchday 2 ──
  { id:"A3", date:"2026-06-19", time:"00:00", group:"A", home:"CZE", away:"RSA", venue:"亚特兰大",
    status:"upcoming", score:null, events:[],
  ...
  { id:"B3", date:"2026-06-19", time:"03:00", group:"B", home:"SUI", away:"BIH", venue:"洛杉矶",
    status:"upcoming", score:null, events:[],
  ...
  { id:"B4", date:"2026-06-19", time:"06:00", group:"B", home:"CAN", away:"QAT", venue:"温哥华",
    status:"upcoming", score:null, events:[],
  ...
  { id:"A4", date:"2026-06-19", time:"09:00", group:"A", home:"MEX", away:"KOR", venue:"瓜达拉哈拉",
    status:"upcoming", score:null, events:[],
  ...
  { id:"D3", date:"2026-06-20", time:"03:00", group:"D", home:"USA", away:"AUS", venue:"西雅图",
    status:"upcoming", score:null, events:[],
  ...
  { id:"C3", date:"2026-06-20", time:"06:00", group:"C", home:"SCO", away:"MAR", venue:"波士顿",
    status:"upcoming", score:null, events:[],
  ...
  { id:"C4", date:"2026-06-20", time:"09:00", group:"C", home:"BRA", away:"HAI", venue:"费城",
    status:"upcoming", score:null, events:[],
  ...
  { id:"D4", date:"2026-06-20", time:"12:00", group:"D", home:"TUR", away:"PAR", venue:"旧金山",
    status:"upcoming", score:null, events:[],
  ...
  { id:"F3", date:"2026-06-21", time:"01:00", group:"F", home:"NED", away:"SWE", venue:"休斯顿",
    status:"upcoming", score:null, events:[],
  ...
  { id:"E3", date:"2026-06-21", time:"04:00", group:"E", home:"GER", away:"CIV", venue:"多伦多",
    status:"upcoming", score:null, events:[],
  ...
  { id:"E4", date:"2026-06-21", time:"08:00", group:"E", home:"ECU", away:"CUW", venue:"堪萨斯城",
    status:"upcoming", score:null, events:[],
  ...
  { id:"F4", date:"2026-06-21", time:"12:00", group:"F", home:"TUN", away:"JPN", venue:"蒙特雷",
    status:"upcoming", score:null, events:[],
  ...
  { id:"H3", date:"2026-06-22", time:"00:00", group:"H", home:"ESP", away:"KSA", venue:"亚特兰大",
    status:"upcoming", score:null, events:[],
  ...
  { id:"G3", date:"2026-06-22", time:"03:00", group:"G", home:"BEL", away:"IRN", venue:"洛杉矶",
    status:"upcoming", score:null, events:[],
  ...
  { id:"H4", date:"2026-06-22", time:"06:00", group:"H", home:"URU", away:"CPV", venue:"迈阿密",
    status:"upcoming", score:null, events:[],
  ...
  { id:"G4", date:"2026-06-22", time:"09:00", group:"G", home:"NZL", away:"EGY", venue:"温哥华",
    status:"upcoming", score:null, events:[],
  ...
  { id:"J3", date:"2026-06-23", time:"01:00", group:"J", home:"ARG", away:"AUT", venue:"达拉斯",
    status:"upcoming", score:null, events:[],
  ...
  { id:"I3", date:"2026-06-23", time:"05:00", group:"I", home:"FRA", away:"IRQ", venue:"费城",
    status:"upcoming", score:null, events:[],
  ...
  { id:"I4", date:"2026-06-23", time:"08:00", group:"I", home:"NOR", away:"SEN", venue:"纽约",
    status:"upcoming", score:null, events:[],
  ...
  { id:"J4", date:"2026-06-23", time:"11:00", group:"J", home:"JOR", away:"ALG", venue:"旧金山",
    status:"upcoming", score:null, events:[],
  ...
  { id:"K3", date:"2026-06-24", time:"01:00", group:"K", home:"POR", away:"UZB", venue:"休斯顿",
    status:"upcoming", score:null, events:[],
  ...
  { id:"L3", date:"2026-06-24", time:"04:00", group:"L", home:"ENG", away:"GHA", venue:"波士顿",
    status:"upcoming", score:null, events:[],
  ...
  { id:"L4", date:"2026-06-24", time:"07:00", group:"L", home:"PAN", away:"CRO", venue:"多伦多",
    status:"upcoming", score:null, events:[],
  ...
  { id:"K4", date:"2026-06-24", time:"10:00", group:"K", home:"COL", away:"COD", venue:"瓜达拉哈拉",
    status:"upcoming", score:null, events:[],
  ...
  // ── Matchday 3 ──
  { id:"B5", date:"2026-06-25", time:"03:00", group:"B", home:"SUI", away:"CAN", venue:"温哥华",
    status:"upcoming", score:null, events:[],
  ...
  { id:"B6", date:"2026-06-25", time:"03:00", group:"B", home:"BIH", away:"QAT", venue:"西雅图",
    status:"upcoming", score:null, events:[],
    prediction:{h:2,a:0, hp:58, dp:28, ap:14, analysis:"波黑为争取出线必须大胜,同时期待另一场结果。卡塔尔已提前出局。波黑实力占优且战意更强,必胜。", factors:"波黑出线希望;卡塔尔毫无斗志"},
    odds:{h:1.50, d:4.00, a:6.00, move:"home_in"}
  },
  { id:"C5", date:"2026-06-25", time:"06:00", group:"C", home:"SCO", away:"BRA", venue:"迈阿密",
    status:"upcoming", score:null, events:[],
  ...
  { id:"C6", date:"2026-06-25", time:"06:00", group:"C", home:"MAR", away:"HAI", venue:"亚特兰大",
    status:"upcoming", score:null, events:[],
  ...
  { id:"A5", date:"2026-06-25", time:"09:00", group:"A", home:"CZE", away:"MEX", venue:"墨西哥城",
    status:"upcoming", score:null, events:[],
  ...
  { id:"A6", date:"2026-06-25", time:"09:00", group:"A", home:"RSA", away:"KOR", venue:"蒙特雷",
    status:"upcoming", score:null, events:[],
  ...
  { id:"E5", date:"2026-06-26", time:"04:00", group:"E", home:"CUW", away:"CIV", venue:"费城",
    status:"upcoming", score:null, events:[],
  ...
  { id:"E6", date:"2026-06-26", time:"04:00", group:"E", home:"ECU", away:"GER", venue:"纽约",
    status:"upcoming", score:null, events:[],
  ...
  { id:"F5", date:"2026-06-26", time:"07:00", group:"F", home:"JPN", away:"SWE", venue:"达拉斯",
    status:"upcoming", score:null, events:[],
  ...
  { id:"F6", date:"2026-06-26", time:"07:00", group:"F", home:"TUN", away:"NED", venue:"堪萨斯城",
    status:"upcoming", score:null, events:[],
  ...
  { id:"D5", date:"2026-06-26", time:"10:00", group:"D", home:"TUR", away:"USA", venue:"洛杉矶",
    status:"upcoming", score:null, events:[],
  ...
  { id:"D6", date:"2026-06-26", time:"10:00", group:"D", home:"PAR", away:"AUS", venue:"旧金山",
    status:"upcoming", score:null, events:[],
  ...
  { id:"I5", date:"2026-06-27", time:"03:00", group:"I", home:"NOR", away:"FRA", venue:"波士顿",
    status:"upcoming", score:null, events:[],
  ...
  { id:"I6", date:"2026-06-27", time:"03:00", group:"I", home:"SEN", away:"IRQ", venue:"多伦多",
    status:"upcoming", score:null, events:[],
    prediction:{h:2,a:0, hp:68, dp:22, ap:10, analysis:"塞内加尔为出线必须取胜且争取净胜球。伊拉克可能已出局。塞内加尔实力碾压,马内领衔的攻击群将全力进攻。", factors:"塞内加尔出线关键;伊拉克已出局"},
    odds:{h:1.30, d:5.00, a:9.00, move:"home_in"}
  },
  { id:"H5", date:"2026-06-27", time:"08:00", group:"H", home:"CPV", away:"KSA", venue:"休斯顿",
    status:"upcoming", score:null, events:[],
  ...
  { id:"H6", date:"2026-06-27", time:"08:00", group:"H", home:"URU", away:"ESP", venue:"瓜达拉哈拉",
    status:"upcoming", score:null, events:[],
  ...
  { id:"G5", date:"2026-06-27", time:"11:00", group:"G", home:"EGY", away:"IRN", venue:"西雅图",
    status:"upcoming", score:null, events:[],
  ...
  { id:"G6", date:"2026-06-27", time:"11:00", group:"G", home:"NZL", away:"BEL", venue:"温哥华",
    status:"upcoming", score:null, events:[],
  ...
  { id:"L5", date:"2026-06-28", time:"05:00", group:"L", home:"PAN", away:"ENG", venue:"纽约",
    status:"upcoming", score:null, events:[],
    prediction:{h:0,a:3, hp:8, dp:15, ap:77, analysis:"英格兰已提前出线,但会争取小组第一以选择淘汰赛路径。巴拿马可能已出局。英格兰阵容深度恐怖,预计大胜。", factors:"英格兰争小组头名;巴拿马已出局"},
    odds:{h:11.00, d:5.50, a:1.22, move:"away_heavy"}
  },
  { id:"L6", date:"2026-06-28", time:"05:00", group:"L", home:"CRO", away:"GHA", venue:"费城",
    status:"upcoming", score:null, events:[],
  ...
  { id:"K5", date:"2026-06-28", time:"07:30", group:"K", home:"COL", away:"POR", venue:"迈阿密",
    status:"upcoming", score:null, events:[],
  ...
  { id:"K6", date:"2026-06-28", time:"07:30", group:"K", home:"COD", away:"UZB", venue:"亚特兰大",
    status:"upcoming", score:null, events:[],
  ...
  { id:"J5", date:"2026-06-28", time:"10:00", group:"J", home:"ALG", away:"AUT", venue:"堪萨斯城",
    status:"upcoming", score:null, events:[],
  ...
  { id:"J6", date:"2026-06-28", time:"10:00", group:"J", home:"JOR", away:"ARG", venue:"达拉斯",
    status:"upcoming", score:null, events:[],
...
const MATCH_DATES = ["2026-06-12", "2026-06-13", "2026-06-14", "2026-06-15", "2026-06-16", "2026-06-17", "2026-06-18", "2026-06-19", "2026-06-20", "2026-06-21", "2026-06-22", "2026-06-23", "2026-06-24", "2026-06-25", "2026-06-26", "2026-06-27", "2026-06-28"];
